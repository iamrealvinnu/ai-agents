...
1. [What’s TaskFlow Agent?](#whats-taskflow-agent)
...
9. [License](#-license)
10. [Acknowledgements](#-shoutouts)

---

## What’s TaskFlow Agent?

**TaskFlow Agent** is more than a to-do list—it’s a productivity powerhouse. Powered by **NeuraX AI**, it uses keyword-based AI to auto-categorize tasks (e.g., “Client Meeting” as Work, “Buy Grocery” as Other), suggests optimal time slots, and keeps your schedule conflict-free.  

Oh, and did we mention the UI? Think holographic task cards, animated data streams, and a midnight blue gradient that screams “future.” Ready to level up your workflow?

---

## ✨ Key Features

- **AI Auto-Categorization**: Automatically categorizes tasks into Work, Personal, or Other using keyword logic—like "client" for Work or "gym" for Personal.
- **Conflict Detection**: Identifies overlapping schedules and warns you (e.g., two Morning tasks).
...
- **Task Management**: Allows sorting by priority, time, or category, marking tasks complete, and exporting them as JSON.
...
[Demo Link](https://drive.google.com/file/d/1qzVCBeT5xxJ8G64nSyG8Cd0-ZBzwaO-x/view?usp=sharing)
...
![Screenshot 1](https://github.com/user-attachments/assets/5704f168-79f2-4546-9c6c-5e613ecf2453)  
![Screenshot 2](https://github.com/user-attachments/assets/277a9c76-1c67-482d-b082-40936c1bc5e4)
...
2. Right-click `index.html` and select **“Open with Live Server”** (runs at `http://127.0.0.1:5500`).
3. Alternatively, use a simple HTTP server:
   ```bash
...
1. **Add a Task**: Type “Client Meeting” or “Out for a Walk” in the input hub. Watch AI auto-categorize!
2. **Set Urgency**: Choose Low, Medium, or High to adjust priority scores.
3. **Sort & Manage**: Sort tasks by priority, time, or category. Mark them complete or export as JSON.
4. **Switch Modes**: Toggle light/dark mode for a personalized vibe.
